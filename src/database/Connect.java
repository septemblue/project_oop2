...
* </strong>
* <br>
* database.Connect.java | This class is used for connection to MySQL database
* <br>
...
public final class Connect {
	...
	private final String DATABASE = "gojek"; // change with the database name that you use
	...
	/**
	* Constructor for database.Connect class
	* <br>
	...
	*/
	...
	/**
	* This method is used for get instance from database.Connect class
	* @return database.Connect This returns instance from database.Connect class
	*/
    public static synchronized Connect getConnection() {
		/**
		* If the connect is null then:
		*   - Create the instance from database.Connect class
